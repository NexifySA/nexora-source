...
import { RequireBilling } from '@gitroom/nestjs-libraries/billing/billing.access.guard';
...
export class IntegrationsController {
  ...
  @RequireBilling('integration_create')
  ...
  async getIntegrationUrl(
    ...
    try {
      ...
      console.error('[integrations] generateAuthUrl failed', {
