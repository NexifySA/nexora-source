    ...
    <main>
      ...
      >
        ...
        <p style={{ ...PARA, marginBottom: 28 }}>
          <em>Última actualización: 20 de mayo de 2026</em>
        </p>
        ...
        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.1 Planes y comercialización</h3>
        <p style={PARA}>
          El Servicio se ofrece mediante planes pagos comercializados por Nexify S.A. Los
          planes vigentes, sus precios y sus límites se publican en{' '}
          <Link href="/pricing" style={{ color: 'var(--nx-accent)' }}>nexpost.com.ar/pricing</Link>,
          que constituye la fuente de información de precios actualizada. Según el plan,
          los ciclos de facturación pueden ser mensuales o anuales. El acceso a las
          funcionalidades pagas depende de la acreditación efectiva del pago
          correspondiente. Cuando ofrezcamos un período de prueba (trial), sus condiciones
          y duración se informan al momento de la contratación.
        </p>

        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.2 Procesamiento de pagos</h3>
        <p style={PARA}>
          Los pagos del Servicio se procesan a través de{' '}
          <strong style={STRONG}>dLocal Go</strong>, un proveedor de procesamiento de
          pagos externo. Para completar una suscripción usted puede ser redirigido a la
          infraestructura de dLocal Go o procesado mediante ella. Al pagar, usted acepta
          los términos y políticas de dLocal Go aplicables a la transacción.
        </p>
        <p style={PARA}>
          Nexpost <strong style={STRONG}>no almacena los datos completos de su tarjeta</strong>{' '}
          ni los datos sensibles de su medio de pago: esa información es recolectada y
          tratada directamente por dLocal Go. Nexpost conserva únicamente metadata de la
          operación y de la suscripción (por ejemplo: plan, estado, identificadores de
          pago, país y moneda) necesaria para prestar el Servicio, emitir comprobantes y
          dar soporte. dLocal Go puede aplicar sus propios controles de validación,
          prevención de fraude y verificación, incluyendo autenticación 3-D Secure cuando
          corresponda.
        </p>
        <p style={PARA}>
          Los importes pueden expresarse en una moneda determinada y ser convertidos por
          dLocal Go o por el emisor de su medio de pago al momento del cobro. El tipo de
          cambio, las comisiones bancarias y los cargos del medio de pago aplicables son
          determinados por dLocal Go y/o por su entidad emisora, no por Nexpost.
        </p>

        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.3 Renovación automática</h3>
        <p style={PARA}>
          Las suscripciones pagas se <strong style={STRONG}>renuevan automáticamente</strong>{' '}
          al finalizar cada período (mensual o anual, según el plan contratado), al precio
          vigente, salvo que usted cancele antes del cierre del período en curso. Al
          contratar, usted autoriza los cobros recurrentes correspondientes. Para evitar
          un nuevo cargo, debe cancelar la suscripción antes de la fecha de renovación.
        </p>

        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.4 Cancelación</h3>
        <p style={PARA}>
          Puede cancelar su suscripción en cualquier momento desde la sección{' '}
          <Link href="/billing" style={{ color: 'var(--nx-accent)' }}>Facturación</Link>{' '}
          de su cuenta, o contactando a soporte en{' '}
          <a href="mailto:contacto@nexify.com.ar" style={{ color: 'var(--nx-accent)' }}>contacto@nexify.com.ar</a>.
          La cancelación detiene las renovaciones futuras: usted conserva el acceso a las
          funcionalidades pagas hasta el final del período ya abonado, y al término de ese
          período el acceso pago finaliza o se limita. La cancelación no genera, por sí
          sola, el reembolso del período en curso.
        </p>

        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.5 Reembolsos</h3>
        <p style={PARA}>
          Los reembolsos se evalúan caso por caso. Podemos otorgar un reembolso, total o
          parcial, en situaciones tales como cobros duplicados, errores de cobro
          atribuibles a Nexpost, o fallas sustanciales del Servicio no resueltas en un
          plazo razonable. Fuera de esos supuestos, y salvo que la normativa de defensa
          del consumidor aplicable disponga lo contrario, los pagos por períodos ya
          iniciados no son reembolsables. Para solicitar la revisión de un cobro, escriba
          a <a href="mailto:contacto@nexify.com.ar" style={{ color: 'var(--nx-accent)' }}>contacto@nexify.com.ar</a>{' '}
          indicando su cuenta y el identificador de la operación; analizaremos el pedido y
          le responderemos.
        </p>

        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.6 Impuestos y cargos</h3>
        <p style={PARA}>
          Los precios publicados pueden no incluir IVA, percepciones, retenciones,
          impuestos a las transacciones, comisiones del medio de pago u otros cargos
          aplicables, los cuales pueden ser adicionados según la normativa del país del
          usuario y/o las reglas de su entidad emisora y de dLocal Go. Nexify emite los
          comprobantes electrónicos que correspondan conforme la normativa argentina
          (AFIP/ARCA).
        </p>

        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.7 Contracargos y pagos rechazados</h3>
        <p style={PARA}>
          Si un pago es rechazado, revertido o sujeto a un contracargo (chargeback), o si
          detectamos un uso fraudulento del medio de pago, podemos suspender o limitar de
          inmediato el acceso a las funcionalidades pagas hasta regularizar la situación.
          Podemos solicitarle información adicional para verificar la titularidad del
          medio de pago o la legitimidad de la operación. Iniciar un contracargo sin
          intentar antes resolver el reclamo con nosotros puede derivar en la suspensión
          de la cuenta.
        </p>

        <h3 style={{ ...SECTION_TITLE, fontSize: 20, margin: '24px 0 8px' }}>4.8 Cambios de precio</h3>
        <p style={PARA}>
          Podemos modificar los precios para períodos de facturación futuros con al menos
