    ...
    <main>
      ...
      >
        ...
        <p style={PARA}>
          ...
          facturación, domicilio fiscal, CUIT/CUIL/identificadores tributarios,
          identificadores de pago y de suscripción, país y moneda de la operación, y
          registros de eventos de pago. El procesamiento de pagos se realiza a través de{' '}
          <strong style={STRONG}>dLocal Go</strong>, nuestro proveedor externo de pagos:
          los datos completos de tarjeta y de cuenta bancaria son recolectados y tratados
          directamente por dLocal Go. Nexpost <strong style={STRONG}>no almacena los datos
          completos de su tarjeta</strong>; conserva únicamente la metadata de la operación
          y de la suscripción necesaria para prestar el Servicio, emitir comprobantes, dar
          soporte y mantener registros de auditoría.
        </p>
        ...
        <ul style={UL}>
          <li><strong style={STRONG}>Sub-encargados y proveedores de infraestructura</strong> — incluyendo cloud hosting y storage, CDNs, bases de datos, monitoreo de errores y observabilidad, plataformas de soporte, plataformas analíticas y proveedores de modelos IA. Les exigimos seguridad adecuada y que traten los datos sólo bajo nuestras instrucciones. En particular, utilizamos <strong style={STRONG}>dLocal Go</strong> como proveedor de procesamiento de pagos y <strong style={STRONG}>Resend</strong> como proveedor de email transaccional.</li>
