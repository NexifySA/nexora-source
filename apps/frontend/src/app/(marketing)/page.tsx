...
const PLANS = [
  {
    name: 'Standard', price: 19, audience: 'Para creadores de contenido',
    popular: false,
    features: [
      '5 canales',
      '400 posts por mes',
  ...
  {
    name: 'Team', price: 29, audience: 'Para marcas pequeñas',
    popular: false,
    features: [
      '10 canales',
      'Posts ilimitados',
  ...
  {
    name: 'Ultimate', price: 86, audience: 'Para agencias',
    popular: true,
    features: [
      '100 canales',
      'Posts ilimitados',
...
const FEATURES = [
  ...
  {
    n: '03',
    t: 'Editor visual incluido',
    d: 'Editor avanzado de imágenes integrado: recortes, capas, plantillas y exportación lista para cada red.',
  },
  {
    n: '04',
    t: 'Analytics útiles',
...
const STEPS = [
  ...
  { n: 2, t: 'Planificás contenido', d: 'Editor avanzado de imágenes, biblioteca de medios y borradores.' },
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Desde el plan Team incluye miembros de equipo, roles y workflow colaborativo. Pro y Ultimate suman más canales y más webhooks.',
  },
  {
    q: '¿Puedo usarlo para agencia?',
    a: 'Ultimate está pensado para agencias: hasta 100 canales, miembros de equipo, alto volumen de webhooks y soporte multi-marca.',
  },
  {
    ...
    >
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
        ...
        >
          ...
          custom, escribinos.
          <br /><br />
          Las funcionalidades pueden variar según el canal conectado, las aprobaciones de cada
          plataforma externa y los límites técnicos de cada proveedor. Las funciones de
          inteligencia artificial e integraciones personalizadas pueden requerir implementación
          adicional.
        </p>
      </div>
    </section>
