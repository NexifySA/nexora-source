    ...
    <html>
      ...
      >
        <VariableContextComponent
          ...
          billingProvider={
            (process.env.BILLING_PROVIDER as 'stripe' | 'dlocal_go' | 'none') ||
            (process.env.STRIPE_PUBLISHABLE_KEY ? 'stripe' : 'none')
          }
          language={language}
          transloadit={
        ...
        >
          <SentryComponent>
            ...
            <FacebookComponent />
            <Plausible
              domain={!!process.env.IS_GENERAL ? 'nexpost.com.ar' : 'gitroom.com'}
            >
              <PHProvider
