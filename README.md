<!--
  Nexpost by Nexify — white-label fork de Postiz (AGPL-3.0).
  Para detalles del despliegue, branding y operación ver `docs/`.
  El bloque siguiente es el README upstream de Postiz, preservado para atribución.
-->

# Nexpost by Nexify

> Despliegue white-label de [Postiz](https://github.com/gitroomhq/postiz-app) operado por Nexify.
> Producción: **https://nexpost.com.ar**.

## Documentación

- **Índice general:** [`docs/README.md`](./docs/README.md)
- **Cómo desplegar:** [`docs/01-deploy/DEPLOY_NEXIFY_POSTIZ.md`](./docs/01-deploy/DEPLOY_NEXIFY_POSTIZ.md)
- **Aviso AGPL / atribución:** [`WHITE_LABEL_NOTICE.md`](./WHITE_LABEL_NOTICE.md)
- **Conectar redes sociales (OAuth):** [`docs/03-security/OAUTH_PROVIDERS_NEXIFY_POSTIZ.md`](./docs/03-security/OAUTH_PROVIDERS_NEXIFY_POSTIZ.md)
- **Sync con upstream Postiz:** [`docs/05-upstream/UPSTREAM_SYNC.md`](./docs/05-upstream/UPSTREAM_SYNC.md)
- **Guía de marca:** [`branding/nexify/BRAND_GUIDE.md`](./branding/nexify/BRAND_GUIDE.md)
